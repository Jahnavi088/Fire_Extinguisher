...
const KPI_CARDS = [
  ...
  { type: 'active', label: 'Operational', icon: '✅', color: '#10b981', key: 'active' },
...
const fetchByType = async (type, moduleId = 7) => {
  if (type === 'active') {
...
/* ══════════════════════════════════════════════════════════════════════════ */
const SuppressionSystemStats = ({ module, onBack, onRaiseWorkOrder }) => {
                  ...
                  <ResponsiveContainer>
                    <BarChart data={[
                      ...
                      <Bar dataKey="val" radius={[4, 4, 0, 0]} barSize={55}>
                        {[{ color: '#10b981' }, { color: '#dc3545' }].map((entry, i) => <Cell key={i} fill={entry.color} />)}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                </div>
