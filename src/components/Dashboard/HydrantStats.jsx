...
const fetchByType = (type) => {
  const params = { module_id: 4, limit: 200 }; // Module ID 4 for Hydrant Points
  ...
  return (
    <div className="fe-pagination">
      <span className="fe-page-info">
        Showing <strong>{start}–{end}</strong> of <strong>{total}</strong> hydrant points
      </span>
    ...
    try {
      ...
      if (!data.items || data.items.length === 0) {
        const mockItems = Array.from({ length: 10 }).map((_, i) => ({
          id: `mock_hp_${i}`,
          sos_code: `HP-${3000 + i}`,
          equipment_type: 'Hydrant Point',
          location_name: 'External Perimeter',
          building_name: 'Plant North',
          readiness_score: 100,
                  ...
                  return (
                    <div key={a.id || i} className="fe-alert-row" style={{ '--alert-color': c }}>
                      ...
                      <div className="fe-alert-meta">
                        ...
                        <div className="fe-alert-type">{a.equipment_type || 'Hydrant'}</div>
                      </div>
                    </div>
                  );
                });
          ...
          <div className="fe-detail-card fe-full">
            ...
            <div className="fe-identity-grid">
              {[
                ...
                { label: 'Type', val: u.equipment_type || 'Hydrant Point' },
          ...
          <div className="fe-detail-card">
            ...
            <div className="fe-condition-pills">
              {[
                ...
                { label: 'Outlets', val: u.outlet_status || 'OK' },
                { label: 'Access', val: u.access_status || 'OK' },
              ].map(pill => {
