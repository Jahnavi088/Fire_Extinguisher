...
const KPI_CARDS = [
  ...
  { type: 'active', label: 'Full Inventory', icon: '✅', color: '#10b981', key: 'active' },
...
/* ══════════════════════════════════════════════════════════════════════════ */
const PPEStationStats = ({ module, onBack, onRaiseWorkOrder }) => {
  const modId = module?.module_id || 49;
              ...
              <>
                <div style={{ height: 160, width: '100%', marginTop: 5 }}>
                  <ResponsiveContainer>
                    <BarChart
                      data={[
                        { name: 'Stocked', val: (summary.active || 0) + (summary.upcoming || 0), color: '#10b981' },
                ...
                <div className="fe-fleet-legend" style={{ marginTop: 20 }}>
                  {[
                    { label: 'Full Stock', val: (summary.active || 0) + (summary.upcoming || 0), color: '#10b981' },
